...
public class SimularDatos {
	...
	private void productosDefecto() {
		...
		this.mercado.crearEditarProducto(2, "Tomate",
				"Es difícil encontrar a alguien a quien no le guste el tomate, y es que el tomate, no solo enriquece nuestras recetas sino que aporta muchos beneficios para la salud.",
				BigDecimal.valueOf(20.00), fotos);
		this.mercado.crearEditarProducto(3, "Pollo",
				"Posiblemente, esta carne sea la más popular del mundo. Esta ave es muy sana, económica, alta en proteínas y baja en grasas. Además, ofrece mucha versatilidad en la cocina y es apta para todo el mundo, al tratarse de una carne blanca.",
		...
		this.mercado.crearEditarProducto(6, "Manzana",
				"La manzana es una fruta de gran valor nutritivo que debe estar presente en nuestra alimentación. ¡Tu salud lo agradecerá! Si aún no estas convencida, te damos más motivos para comer manzana.",
		...
		this.mercado.crearEditarProducto(12, "Camara Web",
				"Videoconferencias Full HD 1080p (hasta 1920 x 1080 pixeles) con la versión más reciente de Skype para Windows. Videoconferencias HD 720p (1280 x 720 pixeles) con clientes compatibles. Grabaciones de video Full HD (hasta 1920 x 1080 pixeles).",
